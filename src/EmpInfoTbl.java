...
public class EmpInfoTbl extends AbstractTableModel {
	
	private static final long serialVersionUID = 1L;
	private String[] colNames = {"EID","Name","Contact","Address","post","Salary","Join"};
	private ArrayList<EList> elist = new ArrayList<EList>();
	
	public EmpInfoTbl(String pt, String key) {
